...
public partial class Default : System.Web.UI.Page
{
    ...
    protected void GAP_butt1(object sender, EventArgs e)
    {
        //Convert.ToDouble(DIFD19.Text) / 1000
         ...
         //string temp_DIFD19 = Convert.ToString( Math.Round(Convert.ToDouble(DIFD19.Text)/1000 ,2));
        //string temp_DIFG19 = Convert.ToString(Math.Round(Convert.ToDouble(DIFG19.Text) / 1000, 2));
        ...
        if (true) {
            ...
            {
                gap3.Text = "Y";
                gap3.ForeColor = System.Drawing.Color.Red;
            }
            else
            {
                gap3.Text = "N";
            ...
            if (POR_34.Text == Man_07.Text)
            {
                ...
                Eff_27.Text = Str_Effect[10] + "<br />" + Str_Effect[5] + "<br />" + Str_Effect[7] + "<br />" + Str_Effect[8] + "<br />";
            }
            else
            {
                gap27.Text = "N";
            ...
            if (POR_50.Text == Man_08.Text)
            {
                ...
                Eff_28.Text = Str_Effect[10] + "<br />" + Str_Effect[5] + "<br />" + Str_Effect[7] + "<br />" + Str_Effect[8] + "<br />";
            }
            else
            {
                gap28.Text = "N";
            ...
            if (POR_19.Text == DIFD29.Text)
            {
                ...
                Eff_31.Text = Str_Effect[7] + " <br />" + Str_Effect[8];
            }
            else
            {
                gap31.Text = "N";
            ...
            if (POR_35.Text == APP_09.Text)
            {
                ...
                Eff_32.Text = Str_Effect[7] + " <br />" + Str_Effect[2];
            ...
            if (POR_22.Text == Man_11.Text)
            {
                ...
                Eff_34.Text = Str_Effect[10] + "<br />" + Str_Effect[5] + "<br />" + Str_Effect[11] + "<br />" + Str_Effect[8] + "<br />" + Str_Effect[0] + "<br />";
            }
            else
            {
                gap34.Text = "N";
